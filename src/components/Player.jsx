        ...
        <div className='flex h-full flex-row justify-between items-center px-4 z-50'>
            ...
            <div className='w-2/4 grid place-content-center gap-4 flex-1'>
                <div className='flex justify-center gap-4'>
                    ...
                    <button className="p-2 rounded-full bg-white transition-transform hover:scale-105" onClick={() => setIsPlaying(!isPlaying)}>
            ...
            <div className="w-1/4 flex justify-end">Volumen</div>
        </div>
    )
}
